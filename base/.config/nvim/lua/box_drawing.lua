...
function box_drawing_start()
	...
	vim.keymap.set(NORMAL, "h", function()
		box_drawing_move(LEFT)
	end, keymap_opts)
	vim.keymap.set(NORMAL, "j", function()
		box_drawing_move(DOWN)
	end, keymap_opts)
	vim.keymap.set(NORMAL, "k", function()
		box_drawing_move(UP)
	end, keymap_opts)
	vim.keymap.set(NORMAL, "l", function()
		box_drawing_move(RIGHT)
	end, keymap_opts)
